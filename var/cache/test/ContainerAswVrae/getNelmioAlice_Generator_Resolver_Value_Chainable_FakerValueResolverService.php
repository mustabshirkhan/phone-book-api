 ...
 */
class getNelmioAlice_Generator_Resolver_Value_Chainable_FakerValueResolverService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['nelmio_alice.generator.resolver.value.chainable.faker_value_resolver'] = new \Nelmio\Alice\Generator\Resolver\Value\Chainable\FakerFunctionCallValueResolver(($container->services['Faker\\Generator'] ?? $container->load('getGeneratorService')));
    }
}
