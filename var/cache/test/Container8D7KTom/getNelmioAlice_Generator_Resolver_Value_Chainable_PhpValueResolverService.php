 ...
 */
class getNelmioAlice_Generator_Resolver_Value_Chainable_PhpValueResolverService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['nelmio_alice.generator.resolver.value.chainable.php_value_resolver'] = new \Nelmio\Alice\Generator\Resolver\Value\Chainable\PhpFunctionCallValueResolver($container->parameters['nelmio_alice.functions_blacklist'], ($container->privates['nelmio_alice.generator.resolver.value.chainable.faker_value_resolver'] ?? $container->load('getNelmioAlice_Generator_Resolver_Value_Chainable_FakerValueResolverService')));
    }
}
