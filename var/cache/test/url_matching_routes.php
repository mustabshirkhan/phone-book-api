...
return [
    ...
    [ // $dynamicRoutes
        ...
        201 => [
            [['_route' => 'api_contacts_put_item', '_controller' => 'App\\Controller\\ContactsUpdateAction', '_format' => null, '_stateless' => null, '_api_resource_class' => 'App\\Entity\\Contact', '_api_identifiers' => ['id'], '_api_has_composite_identifier' => false, '_api_item_operation_name' => 'put'], ['id'], ['POST' => 0], null, false, true, null],
